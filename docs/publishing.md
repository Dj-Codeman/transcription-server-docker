...
# 2) Build
docker build -f docker/Dockerfile -t whisper-api:latest .
# 3) Tag
docker tag whisper-api:latest ghcr.io/dj-codeman/whisper-api:v0.1.11
docker tag whisper-api:latest ghcr.io/dj-codeman/whisper-api:latest
# 4) Push
docker push ghcr.io/dj-codeman/whisper-api:v0.1.11
